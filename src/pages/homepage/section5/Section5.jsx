        ...
        <div className="section5div">
          <div className="section5TextDiv">
            <h3 className="section5h3" data-aos="fade-up">
              {dil === "RU"
                ? "Наши полотенца изготовлены из высококачественных материалов, мягких и впитывающих влагу, что делает их идеальными для использования в любых условиях."
            ...
            >
              <span className="section5butontext">
                {dil === "RU" ? "Перейти к полотенцам" : "Go to towels"}
              </span>
            </button>
          </div>
