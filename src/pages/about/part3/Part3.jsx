        ...
        <div className="part3Div">
          <div className="part3TextDiv1">
            <p className="part3text" data-aos="fade-right">
              {dil === "RU"
                ? "Как индивидуальное предприятие, мы стремимся предоставлять нашим клиентам наилучшие продукты и услуги. Наша команда опытных профессионалов стремится к тому, чтобы каждый продукт, который мы производим, соответствовал нашим высоким стандартам качества и совершенства."
          ...
          <div className="part3TextDiv2">
            <p className="part3text" data-aos="fade-left">
              {dil === "RU"
